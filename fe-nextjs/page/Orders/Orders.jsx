...
export default function Orders() {
  ...
  const [reviewedOrders, setReviewedOrders] = useState(() => JSON.parse((typeof window !== "undefined" ? localStorage : {getItem:()=>null,setItem:()=>{},removeItem:()=>{}}).getItem("reviewedOrders") || "[]"));
